...
// -- Main functions -- 
void VulkanDevices::pickPhysicalDevice(VkInstance &instance, VkSurfaceKHR &surface) {
...
void VulkanDevices::createLogicalDevice(const std::vector<const char*> validationLayers, VkSurfaceKHR &surface) {
